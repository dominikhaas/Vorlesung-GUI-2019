...
public class HeaderController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        createBookmarkButton.setOnAction((event) -> {
            SimpleEventBus.getBus().publish(new StatusEvent("Creating bookmark ..."));
        });
        addToGraphButton.setOnAction((event) -> {
            SimpleEventBus.getBus().publish(new StatusEvent("Adding to graph ..."));
        });
    }
    ...
    private void onGenerateGraph(ActionEvent e) {
        ...
        SimpleEventBus.getBus().publish(new StatusEvent("Generating graph ..."));
    }
